...
public class Notifications {
  ...
  void getNotification(Uri uri) {
    ...
    if (Build.VERSION.SDK_INT >= 19) {
      ...
      notification.contentIntent = PendingIntent.getActivity(service, 2, new Intent(service, ServiceControl.class).addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION | Intent.FLAG_ACTIVITY_NO_HISTORY).putExtra(ACTION.TYPE, ACTION.PLAY_PAUSE).putExtra(ACTION.SELF_IDENTIFIER, ACTION.SELF_IDENTIFIER_ID), pendingIntentFlag);
